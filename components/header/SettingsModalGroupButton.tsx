...
export const SettingsModalGroupButton = ({
  ...
  return (
    <div className="flex justify-center items-center">
      <button
        onClick={onClick}
        className="flex justify-center items-center bg-tigres-row-button dark:bg-dark-tigres-row-button peer dark:hover:bg-tigres-row-hover hover:bg-tigres-row-hover transition duration-200 rounded-xl h-8 w-8"
      >
        {icon}
      </button>
