...
export const tokens: TokenInfo[] = [
  {
    symbol: "WETH",
    icon: <Image src="/tokens/weth.png" width={24} height={24} alt="WETH" />,
  },
  {
    symbol: "ETH",
    icon: <Image src="/tokens/eth.png" width={24} height={24} alt="ETH" />,
  },
  {
    symbol: "DAI",
    icon: <Image src="/tokens/dai.png" width={24} height={24} alt="DAI" />,
  },
];
...
export const TokenInput = forwardRef(
  ({ defaultSymbol, onChangeData }: ITokenInputProps, ref) => {
    ...
    return (
      <div className="flex items-center justify-between p-4 my-0.5 h-24 bg-input-background dark:bg-dark-input-background rounded-xl border border-input-border border-opacity-0 focus-within:!border-opacity-[0.4] hover:border-opacity-[0.08] transition duration-[150ms]">
        <div className="flex-grow">
          <input
            className="w-full focus:outline-0 bg-transparent h-fit overflow-auto placeholder-tigres-placeholder dark:placeholder-dark-tigres-placeholder text-4xl font-normal text-tigres-black dark:text-white"
            type="number"
            value={value}
            placeholder="0"
            onChange={(evt) => {
        ...
        <div className="flex flex-col items-end ml-2">
          <button
            ...
            className={`dark:text-white text-center h-fit py-1 pr-1 pl-2 rounded-2xl font-semibold transition duration-[150ms] ${
              selectedToken
